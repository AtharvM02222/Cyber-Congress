...
import { CornerSquiggles, CornerZigZag } from "@/components/ui/page-doodles";

export default function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] overflow-hidden relative w-full">
      <CornerSquiggles className="absolute top-0 md:top-8 left-0 md:left-8 w-32 md:w-64 h-32 md:h-64 text-[#5a7a5a] -z-10 hidden md:block" />
      <CornerZigZag className="absolute bottom-0 md:bottom-8 right-0 md:right-8 w-32 md:w-48 h-32 md:h-48 text-[#5a7a5a] -z-10 hidden md:block" />
